...
mod eager_loading_with_string_keys {
    ...
    fn eager_loading_associations_for_multiple_records() {
        ...
        connection
            .batch_execute(
                r#"
            CREATE TABLE users (id NVARCHAR(MAX) NOT NULL);
            CREATE TABLE posts (id NVARCHAR(MAX) NOT NULL, user_id NVARCHAR(MAX) NOT NULL);
    ...
    connection
        .batch_execute(
            ...
            CREATE TABLE users1 (id INT PRIMARY KEY,
                                name TEXT NOT NULL);
            CREATE TABLE posts1 (id INT PRIMARY KEY,
